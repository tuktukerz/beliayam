...
<main class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
    <h1 class="font-bold text-2xl md:text-4xl text-center my-16">ABOUT <span class="text-red-600">US</span></h1>

    <section class="mb-24">
        <div class="my-6 border-b-2 border-red-600 w-fit pb-2">
            <h1 class="font-bold text-2xl md:text-3xl">Frequently Asked Questions (FAQ)</h1>
        </div>
        @foreach ($faqs as $faq)
