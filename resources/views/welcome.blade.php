...
<section class="bg-white dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <img class="w-full dark:hidden"
             src="{{ asset('images/cooking.png') }}"
             alt="dashboard image">
        <img class="w-full hidden dark:block"
             src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/cta/cta-dashboard-mockup-dark.svg"
             alt="dashboard image">
        <div class="mt-4 md:mt-0">
            <h1 class="font-bold text-3xl lg:text-5xl italic md:mb-6">Sudah makan <span
                    class="text-red-600">ayam dan telur</span> hari ini ?</h1>
            <h2 class="text-sm text-gray-600 lg:text-3xl italic">Yuk, hidup sehat dengan Protein hemat. Siap bantu untuk
                        ...
                        <li class="mb-4">
                            <div class="group flex items-center gap-2">
                                ...
                                <a href="https://wa.me/{{ $identities->phone }}" target="_blank"
                                    class="group-hover:text-yellow-300 text-sm font-light text-gray-800">{{ $identities->phone }}</a>
                            </div>
                        </li>
                        <li>
                            <div class="group flex items-center gap-2 justify-center">
                                ...
                                <a href="mailto:{{ $identities->email }}" target="_blank"
                                    class="group-hover:text-yellow-300 text-sm font-light text-gray-800">{{ $identities->email }}/</a>
                            </div>
                        </li>
                    </ul>
