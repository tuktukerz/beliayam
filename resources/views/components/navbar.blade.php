<nav class="bg-white border-gray-200 dark:bg-gray-900 mx-6">
    <div class=" flex flex-wrap items-center justify-between p-4 md:p-0">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('images/logo-b.png') }}" class="h-6 md:h-12" alt="Beli Ayam Logo" />
        </a>
        ...
        <div class="hidden w-full md:h-full md:block md:w-auto" id="navbar-default">
            <ul
