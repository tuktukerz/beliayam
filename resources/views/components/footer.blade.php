        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse mb-4">
                    <img src="{{ asset('storage/logo/' . $logoBlack . '?ver=' . strtotime($updatedAt)) }}" class="h-12"
                         alt="Beli Ayam Logo"/>
                </a>
                <p class="text-gray-600 text-sm max-w-md text-justify pr-4">{{ $footerDesc }}</p>
            </div>
            <div class="flex gap-8 sm:gap-16 flex-wrap">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <div class="group flex items-center gap-2">
                                <x-icon link="https://wa.me/{{ $phone }}" alt="Whatsapp number"
                        ...
                        <li>
                            <div class="group flex items-center gap-2 justify-center">
                                <x-icon link="mailto:{{ $email }}" alt="Whatsapp number"
                    ...
                    <x-Socials :$youtube :$instagram :$twitter/>
                </div>
            </div>
        </div>
