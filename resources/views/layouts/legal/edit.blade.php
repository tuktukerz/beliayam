                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="type" required>
                                                        ...
                                                        <option value="tos" @selected($legal->type == 'tos')>Syarat & Ketentuan Pengguna</option>
                                                        <option value="privacy" @selected($legal->type == 'privacy')>Kebijakan Privasi</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            @error('type')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" placeholder="Description" name="description"
                                                    value="{{ $legal->description}}" rows="5"></textarea>
                                            </div>
                                            @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
