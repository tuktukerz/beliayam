                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('about.update', $about->id) }}" class="form" method="post"
                                        ...
                                        <div class="col">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <select class="form-select" id="basicSelect" name="type"
                                                            ...
                                                            @foreach (['vision', 'mission', 'story', 'activities', 'roadmap', 'place'] as $option)
                                                                <option value="{{ $option }}"
                                                                    @if ($about->type == $option) selected @endif>
                                                                    {{ ucfirst($option) }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <img
                                                    src="{{ asset('storage/' . $about->type . '/' . $about->image . '?ver=' . strtotime($about->updated_at)) }}" height="300">
                                            </div>
                                            <div class="col-md-6 col-12">
